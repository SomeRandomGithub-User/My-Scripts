...
local StopItemFarm = Instance.new("TextButton")
...
StopItemFarm.Name = "Stop Item Farm"
StopItemFarm.Parent = menu
StopItemFarm.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
StopItemFarm.BorderSizePixel = 0
StopItemFarm.Position = UDim2.new(2.14364624, 0, 0.157587558, 0)
StopItemFarm.Size = UDim2.new(0, 169, 0, 47)
StopItemFarm.Selected = true
StopItemFarm.Font = Enum.Font.GothamSemibold
StopItemFarm.Text = "Stop Item farm"
StopItemFarm.TextColor3 = Color3.fromRGB(255, 255, 255)
StopItemFarm.TextScaled = true
StopItemFarm.TextSize = 14.000
StopItemFarm.TextWrapped = true

UICorner_4.CornerRadius = UDim.new(0.125, 0)
UICorner_4.Parent = StopItemFarm

buton.Name = "buton"
buton.Parent = menu
buton.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton.BorderSizePixel = 0
buton.Position = UDim2.new(1.09392262, 0, 0.280155659, 0)
...
buton_2.Position = UDim2.new(2.14364624, 0, 0.280155659, 0)
...
buton_3.Position = UDim2.new(1.09392262, 0, 0.385214001, 0)
...
buton_4.Position = UDim2.new(1.09392262, 0, 0.509727597, 0)
...
buton_5.Position = UDim2.new(2.14364624, 0, 0.509727597, 0)
...
buton_6.Position = UDim2.new(1.09392262, 0, 0.632295728, 0)
...
UICorner_5.Parent = buton_6

buton_7.Name = "buton"
buton_7.Parent = menu
buton_7.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_7.BorderSizePixel = 0
buton_7.Position = UDim2.new(2.14364624, 0, 0.632295728, 0)
...
UICorner_6.Parent = buton_7

buton_8.Name = "buton"
buton_8.Parent = menu
buton_8.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_8.BorderSizePixel = 0
buton_8.Position = UDim2.new(2.14364624, 0, 0.385214001, 0)
...
UICorner_7.Parent = buton_8

buton_9.Name = "buton"
buton_9.Parent = menu
buton_9.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_9.BorderSizePixel = 0
buton_9.Position = UDim2.new(1.09392262, 0, 0.741245151, 0)
...
buton_10.Position = UDim2.new(2.14364624, 0, 0.741245151, 0)
...
local function XNDU_fake_script() -- roka.execution 
...
coroutine.wrap(XNDU_fake_script)()
local function TTYZHY_fake_script() -- FPS.LocalScript 
...
coroutine.wrap(TTYZHY_fake_script)()
local function XTTQUOK_fake_script() -- Rokanarrow.execution 
...
coroutine.wrap(XTTQUOK_fake_script)()
local function LZALVH_fake_script() -- usearrowwithworthi.LocalScript 
...
coroutine.wrap(LZALVH_fake_script)()
local function PRBIXCC_fake_script() -- plrName.plrName 
	local script = Instance.new('LocalScript', plrName)

	script.parent.Text = game.Players.LocalPlayer.Name
end
coroutine.wrap(PRBIXCC_fake_script)()
local function QWXRD_fake_script() -- RefreshESP.execution 
...
coroutine.wrap(QWXRD_fake_script)()
local function HOAI_fake_script() -- itemEsp.execution 
...
coroutine.wrap(HOAI_fake_script)()
local function IEAZKZ_fake_script() -- Discord.execution 
...
coroutine.wrap(IEAZKZ_fake_script)()
local function BKTFY_fake_script() -- StopItemFarm.execution 
	local script = Instance.new('LocalScript', StopItemFarm)
...
coroutine.wrap(BKTFY_fake_script)()
local function UBTVZS_fake_script() -- buton.execution 
...
coroutine.wrap(UBTVZS_fake_script)()
local function GDYYURJ_fake_script() -- buton_2.execution 
...
coroutine.wrap(GDYYURJ_fake_script)()
local function SHCSZ_fake_script() -- buton_3.execution 
...
coroutine.wrap(SHCSZ_fake_script)()
local function PQEI_fake_script() -- buton_4.execution 
...
coroutine.wrap(PQEI_fake_script)()
local function QEMUCQ_fake_script() -- buton_5.execution 
...
coroutine.wrap(QEMUCQ_fake_script)()
local function YSVF_fake_script() -- buton_6.execution 
...
coroutine.wrap(YSVF_fake_script)()
local function ZZIFAZP_fake_script() -- buton_7.execution 
...
coroutine.wrap(ZZIFAZP_fake_script)()
local function IGCJCVG_fake_script() -- buton_8.execution 
...
coroutine.wrap(IGCJCVG_fake_script)()
local function SLLH_fake_script() -- buton_9.execution 
...
coroutine.wrap(SLLH_fake_script)()
local function JCNTUI_fake_script() -- buton_10.execution 
...
coroutine.wrap(JCNTUI_fake_script)()
local function ZYJTYK_fake_script() -- buton_11.execution 
...
coroutine.wrap(ZYJTYK_fake_script)()
local function LHIGLHS_fake_script() -- SellItem.execution 
...
coroutine.wrap(LHIGLHS_fake_script)()
local function CAFAD_fake_script() -- Pluck.execution 
...
coroutine.wrap(CAFAD_fake_script)()
local function OHROJZW_fake_script() -- Arcade.execution 
...
coroutine.wrap(OHROJZW_fake_script)()
local function HYFT_fake_script() -- itemFarm.item farm 
...
coroutine.wrap(HYFT_fake_script)()
local function LMJZY_fake_script() -- main.switchhandler 
...
coroutine.wrap(LMJZY_fake_script)()
local function BZILZH_fake_script() -- main.Dragify 
	local script = Instance.new('LocalScript', main)
...
coroutine.wrap(BZILZH_fake_script)()
local function VFEG_fake_script() -- Open.execution 
...
coroutine.wrap(VFEG_fake_script)()
