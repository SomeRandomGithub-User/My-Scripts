...
local buton_13 = Instance.new("TextButton")
...
buton.Position = UDim2.new(1.09392262, 0, 0.157587558, 0)
...
buton_2.Position = UDim2.new(2.14364624, 0, 0.157587558, 0)
...
UICorner_5.Parent = buton_2

buton_3.Name = "buton"
buton_3.Parent = menu
buton_3.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_3.BorderSizePixel = 0
buton_3.Position = UDim2.new(1.09392262, 0, 0.280155659, 0)
...
UICorner_6.Parent = buton_3

buton_4.Name = "buton"
buton_4.Parent = menu
buton_4.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_4.BorderSizePixel = 0
buton_4.Position = UDim2.new(2.14364624, 0, 0.280155659, 0)
...
UICorner_7.Parent = buton_4

buton_5.Name = "buton"
buton_5.Parent = menu
buton_5.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_5.BorderSizePixel = 0
buton_5.Position = UDim2.new(1.09392262, 0, 0.385214001, 0)
...
UICorner_8.Parent = buton_5

buton_6.Name = "buton"
buton_6.Parent = menu
buton_6.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_6.BorderSizePixel = 0
buton_6.Position = UDim2.new(1.09392262, 0, 0.509727597, 0)
...
UICorner_9.Parent = buton_6

buton_7.Name = "buton"
buton_7.Parent = menu
buton_7.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_7.BorderSizePixel = 0
buton_7.Position = UDim2.new(2.14364624, 0, 0.509727597, 0)
...
UICorner_10.Parent = buton_7

buton_8.Name = "buton"
buton_8.Parent = menu
buton_8.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_8.BorderSizePixel = 0
buton_8.Position = UDim2.new(1.09392262, 0, 0.632295728, 0)
...
UICorner_11.Parent = buton_8

buton_9.Name = "buton"
buton_9.Parent = menu
buton_9.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_9.BorderSizePixel = 0
buton_9.Position = UDim2.new(2.14364624, 0, 0.632295728, 0)
...
buton_12.Position = UDim2.new(2.14364624, 0, 0.741245151, 0)
...
UICorner_14.Parent = buton_12

buton_13.Name = "buton"
buton_13.Parent = menu
buton_13.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
buton_13.BorderSizePixel = 0
buton_13.Position = UDim2.new(1.09392262, 0, 0.83463037, 0)
buton_13.Size = UDim2.new(0, 169, 0, 47)
buton_13.Selected = true
buton_13.Font = Enum.Font.GothamSemibold
buton_13.Text = "WIP"
buton_13.TextColor3 = Color3.fromRGB(255, 255, 255)
buton_13.TextScaled = true
buton_13.TextSize = 14.000
buton_13.TextWrapped = true
...
UICorner_17.CornerRadius = UDim.new(0.5, 0)
UICorner_17.Parent = Open

-- Scripts:

local function REFMIT_fake_script() -- roka.execution 
...
coroutine.wrap(REFMIT_fake_script)()
local function BTRSCMN_fake_script() -- FPS.LocalScript 
...
coroutine.wrap(BTRSCMN_fake_script)()
local function KPFDZH_fake_script() -- Rokanarrow.execution 
...
coroutine.wrap(KPFDZH_fake_script)()
local function PADWX_fake_script() -- usearrowwithworthi.LocalScript 
...
coroutine.wrap(PADWX_fake_script)()
local function HVDW_fake_script() -- plrName.plrName 
	local script = Instance.new('LocalScript', plrName)

	script.parent.Text = game.Players.LocalPlayer.Name
end
coroutine.wrap(HVDW_fake_script)()
local function UTHUR_fake_script() -- RefreshESP.execution 
...
coroutine.wrap(UTHUR_fake_script)()
local function XWZXZ_fake_script() -- itemEsp.execution 
...
coroutine.wrap(XWZXZ_fake_script)()
local function LJNOU_fake_script() -- buton.execution 
...
coroutine.wrap(LJNOU_fake_script)()
local function ZBNAPC_fake_script() -- buton_2.execution 
...
coroutine.wrap(ZBNAPC_fake_script)()
local function XCOYT_fake_script() -- buton_3.execution 
...
coroutine.wrap(XCOYT_fake_script)()
local function ZMQKJT_fake_script() -- buton_4.execution 
...
coroutine.wrap(ZMQKJT_fake_script)()
local function KASWAJ_fake_script() -- buton_5.execution 
...
coroutine.wrap(KASWAJ_fake_script)()
local function HNMVPF_fake_script() -- buton_6.execution 
...
coroutine.wrap(HNMVPF_fake_script)()
local function KHFW_fake_script() -- buton_7.execution 
...
coroutine.wrap(KHFW_fake_script)()
local function CXPNRD_fake_script() -- buton_8.execution 
...
coroutine.wrap(CXPNRD_fake_script)()
local function NCYIKM_fake_script() -- buton_9.execution 
...
coroutine.wrap(NCYIKM_fake_script)()
local function XCIQ_fake_script() -- buton_10.execution 
...
coroutine.wrap(XCIQ_fake_script)()
local function ZMES_fake_script() -- buton_11.execution 
...
coroutine.wrap(ZMES_fake_script)()
local function ESKZS_fake_script() -- buton_12.execution 
...
coroutine.wrap(ESKZS_fake_script)()
local function HYUVNM_fake_script() -- buton_13.execution 
	local script = Instance.new('LocalScript', buton_13)
...
coroutine.wrap(HYUVNM_fake_script)()
local function VFBF_fake_script() -- SellItem.execution 
...
coroutine.wrap(VFBF_fake_script)()
local function MZNKA_fake_script() -- Pluck.execution 
...
coroutine.wrap(MZNKA_fake_script)()
local function ECOEMY_fake_script() -- Arcade.execution 
...
coroutine.wrap(ECOEMY_fake_script)()
local function RVZBEH_fake_script() -- Discord.execution 
...
coroutine.wrap(RVZBEH_fake_script)()
local function RWLQ_fake_script() -- main.switchhandler 
...
coroutine.wrap(RWLQ_fake_script)()
local function PQFSPYU_fake_script() -- main.Dragify 
	local script = Instance.new('LocalScript', main)
...
coroutine.wrap(PQFSPYU_fake_script)()
local function ZESN_fake_script() -- Open.execution 
...
coroutine.wrap(ZESN_fake_script)()
